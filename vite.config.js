...
const COMPARISON_PAGES = {
  ...
  'tanto-la600s-zenki-kouki.html': { name:'TANTO LA600S 前期・後期', title:'タントLA600S前期・後期の違い・見分け方 | CarVista', description:'標準タントLA600Sの前期と後期を比較。2015年改良、型式、安全装備、中古車の見分け方を解説します。', image:'/images/cars/tanto/la600s-2015-post-facelift-v1.png', models:[{name:'タントLA600S前期',url:'/tanto-la600s-zenki-kouki.html#la600pre'},{name:'タントLA600S後期',url:'/tanto-la600s-zenki-kouki.html#la600post'}] },
