...
const phases = [
  {
    label: '前期', period: '2015年4月24日発売〜2017年9月改良前', image: '/images/cars/stepwgn/rp3-spada-pre-facelift-v1.png',
  ...
  {
    label: '後期', period: '2017年9月29日発売〜2022年4月終了モデル', image: '/images/cars/stepwgn/rp3-spada-post-facelift-v1.png',
...
document.querySelector('#stepwgn-facelift-page').innerHTML = `
  ...
  <section class="facelift-timeline" aria-label="STEPWGN RP系の年式タイムライン"><p class="comparison-eyebrow">TIMELINE BRANCH</p><h2>RP系SPADAは2017年9月29日で分ける</h2><div class="timeline-track"><article><span>2015.04.24</span><h3>5代目RP系を発売</h3><p>標準STEPWGNはFFのRP1／4WDのRP2、SPADAはFFのRP3／4WDのRP4。1.5L直噴VTEC TURBOを搭載しました。</p></article><article><span>2015.04〜2017.09改良前</span><h3>前期SPADA</h3><p>幅広い一枚メッキ、複眼調ランプ、丸型フォグを採用します。</p></article><article class="timeline-change"><span>2017.09.29</span><h3>マイナーチェンジ</h3><p>SPADAの外観を刷新し、インラインLEDライトと専用グリルを採用。RP5のi-MMDハイブリッドも追加されました。</p></article><article><span>2017.09.29発売〜2022.04</span><h3>後期SPADA</h3><p>Honda公式アーカイブでは2022年4月終了モデル。6代目は同年5月27日に発売されました。</p></article></div></section>
