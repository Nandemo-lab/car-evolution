...
const phases = [
  {
    label: '前期', period: '2013年12月2日〜2017年6月7日', image: '/images/cars/harrier/gen3-2013-zsu60w.png',
  ...
  {
    label: '後期', period: '2017年6月8日〜2020年6月16日', image: '/images/cars/harrier/gen3-2017-zsu60w-post-facelift.png',
...
document.querySelector('#harrier-facelift-page').innerHTML = `
  ...
  <section class="facelift-timeline" aria-label="HARRIER 60系の年式タイムライン"><p class="comparison-eyebrow">TIMELINE BRANCH</p><h2>60系は2017年6月8日で分ける</h2><div class="timeline-track"><article><span>2013.12.02</span><h3>3代目60系を発売</h3><p>ガソリン2WDはZSU60W、ガソリン4WDはZSU65W、ハイブリッドE-FourはAVU65Wです。</p></article><article><span>2013.12.02〜2017.06.07</span><h3>前期</h3><p>横長の下部開口と丸型フォグを採用。比較車はPREMIUM Advanced Packageです。</p></article><article class="timeline-change"><span>2017.06.08</span><h3>マイナーチェンジ</h3><p>フロントフェイスと灯火類を変更し、シーケンシャルターンランプを採用。ターボ車も追加されました。</p></article><article><span>2017.06.08〜2020.06.16</span><h3>後期</h3><p>自然吸気ガソリンのZSU60Wを継続。2020年6月17日に80系へ交代しました。</p></article></div></section>
