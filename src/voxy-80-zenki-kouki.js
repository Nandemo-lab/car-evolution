...
const phases = [
  {
    label: '前期', period: '2014年1月〜2017年7月', image: '/images/cars/voxy/80-zs-pre-facelift-v1.png',
  ...
  {
    label: '後期', period: '2017年7月〜2021年12月', image: '/images/cars/voxy/80-zs-post-facelift-v1.png',
...
document.querySelector('#voxy-facelift-page').innerHTML = `
  ...
  <section class="facelift-timeline" aria-label="80系ZSの年式タイムライン"><p class="comparison-eyebrow">TIMELINE BRANCH</p><h2>80系の中を、2017年7月で分ける</h2><div class="timeline-track"><article><span>2014.01.20</span><h3>80系登場</h3><p>ガソリンZSは2WDがDBA-ZRR80W、4WDがDBA-ZRR85W。エアロ専用ワイドボディです。</p></article><article><span>2014–2017.07</span><h3>前期ZS</h3><p>上下2段灯、横基調グリル、丸いプロジェクターと横桟のフォグ周辺が目印です。</p></article><article class="timeline-change"><span>2017.07.03</span><h3>マイナーチェンジ</h3><p>Bi-Beam LEDと面発光LEDクリアランスランプ、ZS専用［ハ］字テーマへ刷新しました。</p></article><article><span>2017.07–2021.12</span><h3>後期ZS</h3><p>ガソリン2WDはDBA-ZRR80W（のち3BA-ZRR80W）。中古車は外観と車検証を併用して確認します。</p></article></div></section>
