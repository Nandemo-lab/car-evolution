...
const phases = [
  {
    label: '前期', period: '2015年12月9日発売〜2018年12月改良前', image: '/images/cars/prius/gen4-2015-zvw51-pre-facelift.png',
  ...
  {
    label: '後期', period: '2018年12月17日発売〜2023年1月', image: '/images/cars/prius/gen4-2018-zvw51-post-facelift.png',
...
document.querySelector('#prius-facelift-page').innerHTML = `
  ...
  <section class="facelift-timeline" aria-label="PRIUS 50系の年式タイムライン"><p class="comparison-eyebrow">TIMELINE BRANCH</p><h2>50系は2018年12月17日で分ける</h2><div class="timeline-track"><article><span>2015.12.09</span><h3>4代目を発売</h3><p>TNGAを初採用。2WDはZVW50/ZVW51、E-FourはZVW55です。</p></article><article><span>2015.12〜2018.12改良前</span><h3>前期</h3><p>縦へ伸びる稲妻形ヘッドランプが外観上の代表的な識別点です。</p></article><article class="timeline-change"><span>2018.12.17</span><h3>マイナーチェンジ</h3><p>グリル、バンパー、ランプ類を変更。A Touring Selection・2WDも継続設定されました。</p></article><article><span>2018.12.17発売〜2023.01</span><h3>後期</h3><p>4代目はToyota公式カタログ上で2023年1月まで。5代目は同月10日に発売されました。</p></article></div></section>
